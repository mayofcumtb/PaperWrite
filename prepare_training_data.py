...
if __name__ == '__main__':
    ...
    for idx, synset in enumerate(g_shape_synsets):
        ...
        ours_get_one_category_image_label_file(synset, os.path.join(g_syn_images_lmdb_folder, name+'_train.txt'), os.path.join((g_syn_images_lmdb_folder, name+'_test.txt')))
